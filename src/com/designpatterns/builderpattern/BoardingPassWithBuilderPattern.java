...
public class BoardingPassWithBuilderPattern {
    ...
    public BoardingPassWithBuilderPattern(
    ...
    public static class BoardingPassBuilder {
        ...
        public BoardingPassWithBuilderPattern
        build() {
            return new BoardingPassWithBuilderPattern(nameOfPassenger, flightNumber, gateNumber,
